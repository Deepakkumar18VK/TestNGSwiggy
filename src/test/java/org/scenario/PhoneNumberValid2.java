...
public class PhoneNumberValid2 extends SwiggyPageFactory {
	...
	PhoneNumberValid2 ex = new PhoneNumberValid2();
		ex.signupClick();
...
//		}
	...
	@Test
	public  void phoneNumberNotInvalid() throws Exception{
		
		ExtentTest logger = extent.createTest("phoneNumberNotInvalid");	
		PhoneNumberValid2 ex = new PhoneNumberValid2();
		ex.signupClick();
		logger.log(Status.INFO, "Clicking on sign up button");
		ex.phonenumberCheck(ReadData.getdatafromexcel("Data", 2, 1));
		ex.continueClick();
		logger.log(Status.INFO, "Clicking on continue button");
